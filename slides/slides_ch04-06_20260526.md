...
<div class="lane"></div>
<div class="facs">
<div class="fac">× 靭性係数 K<sub>jr</sub>（脆性接合部を低減）</div>
</div>
</div>
...
<div class="lane"></div>
<div class="facs">
<div class="fac">× 1/3 ・ K<sub>jd</sub> ・ K<sub>jm</sub></div>
</div>
</div>
...
<div class="facs">
<div class="fac">× 1/3 ・ K<sub>jd</sub> ・ K<sub>jm</sub></div>
<div class="add">靭性係数 K<sub>jr</sub> は削除　[削除]</div>
</div>
</div>
<div class="val">許容せん断耐力 P<sub>a</sub></div>
...
<ul class="flow-notes">
<li>旧版：単位接合部を区別し、<strong>靭性係数 K<sub>jr</sub></strong> で脆性接合部の耐力を直接低減</li>
